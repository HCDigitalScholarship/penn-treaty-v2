...
async def manuscripts(request: Request):
    ...
    sw_data = [['Halliday Jackson 1800 Journal (continued)', 'swarthmore/SW_HJ1800.xml/SW_HJ1800_001', 'sw_manuscript/53', 'Journal'],
               ...
               ["Wm. Hartshorne's Journal of Journey to Detroit 1793", 'swarthmore/SW_WH1793.xml/SW_WH1793_Page_001', 'sw_manuscript/43', 'Diaries'],
               ['Travels in Some Parts of North America, in the Years 1804, 1805, & 1806, by Robert Sutcliff', 'swarthmore/SW_Sutcliff.xml/SW_Sutcliff_Page_001', 'sw_manuscript/28', 'Diaries'],
...
def paginated_manuscripts(request: Request):
    ...
    first_page_dict = {'haverford/hv_sansomj_letters_1796.xml': 'hv_sansomj_letters_1796_001',
     ...
     'swarthmore/SW_SH1799.xml': 'SW_SH1799_Page_01', 'swarthmore/SW_WH1793.xml': 'SW_WH1793_Page_001',
